...
export const navItems: NavItem[] = [
	...
	},
	{
		...
		subItems: [
			...
			{ name: 'Button Group', icon: <Group />, path: '/example/ui-components/button-group', new: true },
			{ name: 'Card', icon: <SquareStack />, path: '/example/ui-components/card', new: true },
			...
			{ name: 'Drawer', icon: <PanelBottom />, path: '/example/ui-components/drawer', new: true },
