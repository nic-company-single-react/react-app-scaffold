...
export const navItems: NavItem[] = [
	...
	},
	{
		...
		subItems: [
			...
			{ name: 'Pagination', icon: <GalleryHorizontalEnd />, path: '/example/ui-components/pagination' },
			...
			{ name: 'Skeleton', icon: <LayoutTemplate />, path: '/example/ui-components/skeleton' },
			{ name: 'Slider', icon: <SlidersHorizontal />, path: '/example/ui-components/slider' },
			...
			{ name: 'Toggle', icon: <ToggleLeft />, path: '/example/ui-components/toggle' },
