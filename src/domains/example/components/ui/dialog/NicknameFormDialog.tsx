...
import { useDialogSubmit } from '@axiom/hooks';
 ...
 */
function NicknameFormDialog({ initial, dialog }: INicknameFormDialogProps & IDialogInjected<string>): React.ReactNode {
...
export default defineDialog<INicknameFormDialogProps, string>(NicknameFormDialog);
